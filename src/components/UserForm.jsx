...
const DEPARTMENTS = ['RD', 'ARDO', 'ARDA', 'RCAO', 'RPBDD', 'RECORDS', 'LEGAL', 'SPLIT UPTOWN', 'SPLIT DOWNTOWN', 'LTI/LTSP', 'PERSONNEL', 'PLANNING', 'SUPPLY', 'MOTORPOOL', 'COA', 'SPECIAL CONCERNS', 'LD', 'IU', 'RMIC', 'ACCOUNTING', 'BUDGET', 'CASHIER', 'DARAB',  'Other']
